...
load("./Data/ANE/Anchovy GSA1718_2idx_sa.RData")
...
#####
# Catchability model
#qmod1 <- list(~ 1, ~1)  # this is the default setting linear catchability: 1 for each of the 2 surveys. This setting works well for anchovy
...
#fmod2 <- ~ s(year, k = 7) + factor(age) # quite good
#fmod2<- ~ s(year, k = 5) # super bad
#fmod2 <- ~ factor(year) # super bad
#fmod3 <- ~ s(age, k = 5) + s(year, k=12)
fmod4 <- ~ s(age, k = 5) + factor(year)                                 # good! Final best model
#fmod5 <- ~ s(age, k = 5) + factor(year) + te(age, year, k = c(2,3))     
...
#fmod9 <- ~ s(age, k = 5) + s(year, k=15) + te(age, year, k = c(4,5)) # also this scenario can be good
#fmod10 <- ~ s(age, k = 5) + s(year, k=10) + te(age, year, k = c(4,5))
#fmod11 <- ~ s(age, k = 5) + s(year, k=18)
...
#### 
# Fit a4a
# fit <- a4aSCA(stock = stk, srmodel=rmodel4, fmodel = fmod3, qmodel=qmod5, indices = ids, verbose = FALSE, fit = "assessment") # not so bad
# fit <- a4aSCA(stock = stk, srmodel=rmodel4, fmodel = fmod9, qmodel=qmod1, indices = ids, verbose = FALSE, fit = "assessment") # quite good
fit <- a4aSCA(stock = stk, srmodel=rmodel4, fmodel = fmod4, qmodel=qmod5, indices = ids, verbose = FALSE, fit = "assessment") # the final one!
...
Fit_Comparison <- FLStocks(samGFCM16 = ANCHOVY2idx, fitA4A = fitA4A)#, fitSimA4A = stks)
...
plot(Fit_Comparison) #, lwd=2) 

save(Fit_Comparison, file="Results/RESULTS OLD MSE/ANE//ANE_Fit_Comparison.Rdata")

png("Results/RESULTS OLD MSE/ANE//PLOTS/ANE_ComparisonSAM_a4a.png", width=1000, height=800, res=120)
plot(Fit_Comparison) + ggtitle("Anchovy GSA17-18") + theme_light(base_size=16) + theme(legend.title = element_blank()) + geom_line(size=1,aes(colour=stock)) # + geom_line(size=1)
dev.off()
...
png("Results/RESULTS OLD MSE/ANE//PLOTS/ANE_a4a_logRESIDUALS.png", width=1000, height=800, res=120)
plot(res) 
dev.off()

# look at plots of survey fits:
png("Results/RESULTS OLD MSE/ANE//PLOTS/ANE_a4a_EchoEastfit.png", width=1000, height=800, res=120)
plot(fit,ids[2])
dev.off()

png("Results/RESULTS OLD MSE/ANE//PLOTS/ANE_a4a_EchoWestfit.png", width=1000, height=800, res=120)
plot(fit,ids[1])
dev.off()
...
it <- 25                              # iterations - should be 250
y0 <- range(ANCHOVY2idx)["minyear"]     # year zero (initial) = 1975
...
ssb <- apply(matrix(as.vector(stk@stock.n*stk@mat*stk@stock.wt), nrow=1+stk@range[[2]] ), 2, sum)  # this is WRONG, TIME OF SPAWNING NOT TAKEN INTO ACCOUNT
...
png("Results/RESULTS OLD MSE/ANE//PLOTS/ANE_segreg_bkptmeanSSB_confidence.png", width=700, height=700)
...
png("Results/RESULTS OLD MSE/ANE//PLOTS/ANE_SR_labeled.png", width=700, height=700)
...
png("Results/RESULTS OLD MSE/ANE//PLOTS/ANE_SSB.png", width=700, height=700)
...
png("Results/RESULTS OLD MSE/ANE//PLOTS/ANE_REC.png", width=700, height=700)
...
png("Results/RESULTS OLD MSE/ANE//PLOTS/ANE_segreg_bkptmaxSSB_confidence.png", width=700, height=700)
...
png("Results/RESULTS OLD MSE/ANE//PLOTS/ANE_segreg_bkptmeanSSB_red_confidence.png", width=700, height=700)
...
png("Results/RESULTS OLD MSE/ANE//PLOTS/ANE_segreg_bkptmaxSSB_red_confidence.png", width=700, height=700)
...
save(list = c("ANE_Opt1a_mse.pstk.GFCM_segregmeanSSB_Fsq0", "ANE_Opt1a_mse.stk0.GFCM_segregmeanSSB_Fsq0"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt1a_mse_SegregmeanSSB_statusQuo_250it.RData")
...
save(list = c("ANE_Opt1d_mse.pstk.GFCM_segregshort_meanSSB_Fsq0", "ANE_Opt1d_mse.stk0.GFCM_segregshort_meanSSB_Fsq0"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt1d_mse_SegregShort_meanSSB_statusQuo_250it.RData")
...
save(list = c("ANE_Opt1e_mse.pstk.GFCM_segregshort_maxSSB_Fsq0", "ANE_Opt1e_mse.stk0.GFCM_segregshort_maxSSB_Fsq0"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt1e_mse_SegregShort_maxSSB_statusQuo_250it.RData")
...
save(list = c("ANE_Opt1f_mse.pstk.GFCM_segregmaxSSB_Fsq0", "ANE_Opt1f_mse.stk0.GFCM_segregmaxSSB_Fsq0"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt1f_mse_SegregmaxSSB_statusQuo_250it.RData")
...
# save(list = c("Opt2_ANE_mse.pstk.GFCM_segreg_Btrig", "Opt2_ANE_mse.stk0.GFCM_segreg_Btrig"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt2_mse_Segreg_GFCM-HCR_Btrig_250it.RData")
...
save(list = c("ANE_Opt2a_mse.pstk.GFCM_segreg_Btrig_noBesc", "ANE_Opt2a_mse.stk0.GFCM_segreg_Btrig_noBesc"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt2a_mse_Segreg_GFCM-HCR_Btrig_250it_noBesc.RData")
...
save(list = c("ANE_Opt2d_mse.pstk.GFCM_segreg_red_maxSSB_Btrig_noBesc", "ANE_Opt2d_mse.stk0.GFCM_segreg_red_maxSSB_Btrig_noBesc"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt2d_mse_Segreg_red_maxSSB_GFCM-HCR_Btrig_250it_noBesc.RData")
...
save(list = c("Pil_Opt3a_mse.pstk.GFCM_segreg_BtrigBpa", "Pil_Opt3a_mse.stk0.GFCM_segreg_BtrigBpa"), file = "Results/RESULTS OLD MSE/ANE//Pil_Opt3_mse_Segreg_GFCM-HCR_Fincrease_BtrigBpa.RData")
...
save(list = c("ANE_Opt4a_mse.pstk.GFCM_segreg_BtarFtar_trgy_250it", "ANE_Opt4a_mse.stk0.GFCM_segreg_BtarFtar_trgy_250it"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt4a_mse_Segreg_FtarBtar_250it.RData")
...
save(list = c("ANE_Opt4b_mse.pstk.GFCM_segreg_maxSSB_BtarFtar_trgy_75it", "ANE_Opt4b_mse.stk0.GFCM_segreg_maxSSB_BtarFtar_trgy_75it"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt4b_mse_Segreg_maxSSB_FtarBtar_75it.RData")
...
save(list = c("ANE_Opt4c_mse.pstk.GFCM_segreg_redmeanSSB_BtarFtar_trgy_250it", "ANE_Opt4c_mse.stk0.GFCM_segreg_redmeanSSB_BtarFtar_trgy_250it"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt4a_mse_Segreg_redmeanSSB_FtarBtar_250it.RData")
...
save(list = c("ANE_Opt4d_mse.pstk.GFCM_segreg_redmaxSSB_BtarFtar_trgy_250it", "ANE_Opt4d_mse.stk0.GFCM_segreg_redmaxSSB_BtarFtar_trgy_250it"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt4d_mse_Segreg_redmaxSSB_FtarBtar_250it.RData")
...
save(list = c("ANE_Opt5_mse.pstk.GFCM_segreg_Fmsy_SQ_250it", "ANE_Opt5_mse.stk0.GFCM_segreg_Fmsy_SQ_250it"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt5_mse_segreg_Fmsy_SQ_250it.RData")
...
# save(list = c("PIL_Opt6a_mse.pstk.GFCM_segreg_9perc_red_250it", "PIL_Opt6a_mse.stk0.GFCM_segreg_9perc_red_250it"), file = "Results/RESULTS OLD MSE/ANE//PIL_Opt6a_mse_segreg_9perc_red_250it.RData")
...
# save(list = c("PIL_Opt6b_mse.pstk.GFCM_segreg_9perc_red_onCatch", "PIL_Opt6b_mse.stk0.GFCM_segreg_9perc_red_onCatch"), file = "Results/RESULTS OLD MSE/ANE//PIL_Opt6b_mse_segreg_9perc_red_250it_onCatch.RData")
...
save(list = c("ANE_Opt7_mse.pstk.GFCM_segreg_bkptmeanSSB_TAC", "ANE_Opt7_mse.stk0.GFCM_segreg_bkptmeanSSB_TAC"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt7_mse_Segreg_bkptmeanSSB_TAC_250it.RData")
...
plot(ANE_Opt7_mse.pstk.GFCM_segreg_bkptmeanSSB_TAC)
save(list = c("ANE_Opt7b_mse.pstk.GFCM_segreg_bkptmeanSSB_mincatchTAC", "ANE_Opt7b_mse.stk0.GFCM_segreg_bkptmeanSSB_mincatchTAC"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt7b_mse_Segreg_bkptmeanSSB_mincatchTAC_250it.RData")
...
save(list = c("ANE_Opt7c_mse.pstk.GFCM_segreg_bkptmeanSSB_fmsycatchTAC", "ANE_Opt7c_mse.stk0.GFCM_segreg_bkptmeanSSB_fmsycatchTAC"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt7c_mse_Segreg_bkptmeanSSB_fmsycatchTAC_250it.RData")
...
save(list = c("ANE_Opt9_mse.pstk.red.F.yr", "ANE_Opt9_mse.stk0.red.F.yr"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt9_mse_Segreg_red.F.yr_250it.RData")
...
save(list = c("ANE_Op12_mse.pstk.GFCM_segreg_20perc_red_250it", "ANE_Opt12_mse.stk0.GFCM_segreg_20perc_red_250it"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt12_mse_segreg_20perc_red_250it.RData")
...
save(list = c("ANE_Op13_mse.pstk.GFCM_segreg_9perc_red_250it", "ANE_Opt13_mse.stk0.GFCM_segreg_9perc_red_250it"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt13_mse_segreg_9perc_red_250it.RData")
...
#plot(ANE_Opt13_mse.pstk.GFCM_segreg_9perc_red_250it)
save(list = c("ANE_Op14_mse.pstk.GFCM_segreg_90perc_red_250it", "ANE_Opt14_mse.stk0.GFCM_segreg_90perc_red_250it"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt14_mse_segreg_90perc_red_250it.RData")
...
save(list = c("ANE_Opt15_mse.pstk.GFCM_segregmeanSSB_redrec", "ANE_Opt15_mse.stk0.GFCM_segregmeanSSB_redrec"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt15_mse_SegregmeanSSB_redrec_250it.RData")
...
save(list = c("ANE_Opt16_mse.pstk.GFCM_segregmeanSSB_allF", "ANE_Opt16_mse.stk0.GFCM_segregmeanSSB_allF"), file = "Results/RESULTS OLD MSE/ANE//ANE_Opt16_mse_SegregmeanSSB_allF_250it.RData")
